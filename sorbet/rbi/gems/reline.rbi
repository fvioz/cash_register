...
class Reline::KeyActor::Base
  ...
  def clear; end
  def get(key); end
  def initialize(mappings = nil); end
...
class Reline::Unicode
  ...
  def self.common_prefix(list, ignore_case: nil); end
  def self.east_asian_width(ord); end
  ...
  def self.safe_encode(str, encoding); end
  def self.space_character?(s); end
  def self.split_by_width(str, max_width); end
  def self.split_line_by_width(str, max_width, encoding = nil, offset: nil); end
  def self.strip_non_printing_start_end(prompt); end
...
class Reline::LineEditor
  ...
  def insert_raw_char(str, arg: nil); end
  ...
  def rerender; end
  def reset(prompt = nil); end
  def reset_line; end
  def reset_variables(prompt = nil); end
  ...
  def split_line_by_width(str, max_width, offset: nil); end
...
class Reline::LineEditor::DialogProcScope
  ...
  def retrieve_completion_block(_unused = nil); end
  def screen_height; end
  def screen_width; end
