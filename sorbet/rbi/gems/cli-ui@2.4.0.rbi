...
class CLI::UI::Color
  ...
  class << self
    ...
    #
    # source://cli-ui//lib/cli/ui/color.rb#101
    ...
    #
    # source://cli-ui//lib/cli/ui/color.rb#92
...
class CLI::UI::Color::InvalidColorName < ::ArgumentError
  ...
  # source://cli-ui//lib/cli/ui/color.rb#72
  sig { returns(::String) }
  def message; end
end
...
class CLI::UI::Formatter
  ...
  #
  # source://cli-ui//lib/cli/ui/formatter.rb#88
  ...
  #
  # source://cli-ui//lib/cli/ui/formatter.rb#104
  ...
  # source://cli-ui//lib/cli/ui/formatter.rb#130
  sig do
    params(
      text: ::String,
  ...
  # source://cli-ui//lib/cli/ui/formatter.rb#192
  sig do
    params(
      sc: ::StringScanner,
  ...
  # source://cli-ui//lib/cli/ui/formatter.rb#148
  sig do
    params(
      sc: ::StringScanner,
      stack: T::Array[T.any(::CLI::UI::Formatter::LITERAL_BRACES, ::String)]
...
class CLI::UI::Formatter::FormatError < ::StandardError
  ...
  # source://cli-ui//lib/cli/ui/formatter.rb#68
  sig { returns(::String) }
  def input; end
...
# source://cli-ui//lib/cli/ui/formatter.rb#49
...
class CLI::UI::Prompt::InteractiveOptions
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#306
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#312
  sig { void }
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#498
  sig { returns(::Integer) }
  def distance_from_selection_to_end; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#503
  sig { returns(::Integer) }
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#513
  sig { void }
  def ensure_last_item_is_continuation_marker; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#491
  sig { void }
  def ensure_visible_is_active; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#418
  sig { returns(T::Boolean) }
  def filtering?; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#218
  sig { void }
  def first_option; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#579
  sig { params(format: ::String, choice: ::String).returns(::String) }
  def format_choice(format, choice); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#423
  sig { returns(T::Boolean) }
  def has_filter?; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#508
  sig { returns(::Integer) }
  def index_of_active_option; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#224
  sig { void }
  def last_option; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#523
  sig { returns(::Integer) }
  def max_lines; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#230
  sig { void }
  def next_page; end
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#528
  sig { void }
  ...
  #
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#255
  sig { params(n: ::Integer, final: T::Boolean).void }
  def select_n(n, final: T.unsafe(nil)); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#413
  sig { returns(T::Boolean) }
  def selecting?; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#282
  sig { params(n: ::Integer).returns(T::Boolean) }
  def should_enter_select_mode?(n); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#428
  sig { void }
  def start_filter; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#434
  sig { void }
  def start_line_select; end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#441
  sig { void }
  ...
  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#318
  sig { params(char: ::String).void }
  def update_search(char); end

  # source://cli-ui//lib/cli/ui/prompt/interactive_options.rb#351
  sig { void }
