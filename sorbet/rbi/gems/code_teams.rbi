...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/code_teams/all/code_teams.rbi
#
# code_teams-1.1.0
...
class CodeTeams::Plugin
  ...
  def self.bust_caches!(*args, **, &blk); end
  def self.clear_team_registry!(*args, **, &blk); end
  def self.data_accessor_name(*args, **, &blk); end
  def self.default_data_accessor_name(*args, **, &blk); end
...
module CodeTeams::Utils
  ...
  def self.demodulize(string); end
  def self.underscore(string); end
  def underscore(string); end
end
class CodeTeams::IncorrectPublicApiUsageError < StandardError
end
class CodeTeams::Team
  ...
  def self.register_plugins(*args, **, &blk); end
